  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/95 backdrop-blur-xl animate-fade-in">
      ...
      <div className="absolute top-6 left-6 z-50 pointer-events-none">
         <h2 className="font-display text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 uppercase tracking-tighter">
            Showroom
         </h2>
      ...
      <div className="absolute bottom-10 inset-x-0 text-center pointer-events-none">
          <p className="text-slate-400 text-xs uppercase tracking-[0.2em] animate-pulse">
             360° Preview Mode
          </p>
      </div>
    </div>
